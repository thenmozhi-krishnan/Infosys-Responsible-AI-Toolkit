...
from presidio_analyzer.nlp_engine import NlpEngine, SpacyNlpEngine, StanzaNlpEngine, ClientNlpEngine
...
class RecognizerRegistry:
    ...
    def _get_nlp_recognizer(
    ...
    ) -> Union[Type[SpacyRecognizer], Type[StanzaRecognizer],Type[ClientListRecognizer]]:
        ...
        if isinstance(nlp_engine, ClientNlpEngine):
            return ClientListRecognizer
        else:
            logger.warning(
    ...
    def add_recognizers_from_yaml(self, yml_path: Union[str, Path]):
        ...
        https://github.com/microsoft/presidio/blob/main/presidio_analyzer/conf/example_recognizers.yaml
