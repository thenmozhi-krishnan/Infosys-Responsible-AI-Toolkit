...
# Test for constants modules
test_constants = '''import pytest
...
with open('test_constants_modules.py', 'w', encoding='utf-8') as f:
    f.write(test_constants)

print('Created test_constants_modules.py')
