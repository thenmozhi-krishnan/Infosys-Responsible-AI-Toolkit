...
Please find the link for **Moderation Model** repo : (https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/tree/Release-2.1.0/responsible-ai-moderationmodel).
