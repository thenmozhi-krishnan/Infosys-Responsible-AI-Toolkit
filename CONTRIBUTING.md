...
✅ **Report Issues**: Found a bug? Create new issue [issue](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/issues) and select `bug` Template and create a bug.
...
✅ **Add Features**: Implement new functionalities to enhance the project. Create new issue [issue](https://github.com/Infosys/Infosys-Responsible-AI-Toolkit/issues) and select `Feature` Template and suggest new Feature.
